            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
                <div className="text-center p-8">
                    ...
                    <div className="text-gray-600 dark:text-gray-400">
                        If it takes too long, check your internet connection.
                    </div>
                    <div className="mt-6">
                    ...
                    <div className={`mx-auto px-4 py-3 ${navAfterBack ? 'max-w-7xl' : 'max-w-4xl'}`}>
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3 text-sm text-gray-700 dark:text-gray-300">
                                <div data-tour="quiz-progress">Progress: <b>{i + 1}/{quizSize}</b></div>
                                {timed && <div className="hidden sm:block" data-tour="quiz-timer">Time: <b>{fmtTime(secsLeft)}</b></div>}
                                <div data-tour="quiz-score">Correct: <b>{correctCount}</b></div>
                                {navAfterBack && <Button onClick={() => setShowConfirm(true)} data-tour="quiz-finish">Finish</Button>}
                                {onVoltar && (
                                    <button
                                        onClick={onVoltar}
            ...
            <Modal open={showConfirm} onClose={() => setShowConfirm(false)} title="Finish Quiz?">
                ...
                <div className="mt-6 flex justify-end gap-2">
                    ...
                    <Button onClick={() => {
                        ...
                        finalize();
                    }} className="bg-red-600 hover:bg-red-700">Yes, finish</Button>
                </div>
            </Modal>
